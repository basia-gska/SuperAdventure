...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Item(ITEM_ID_ADVENTURER_PASS, "Adventurer pass", "Advemturer passes"));
        }
        ...
        private static void PopulateMonsters()
        {
            ...
            giantSpider.LootTable.Add(new LootItem(ItemByID(ITEM_ID_SNAKE_FANG), 75, true));
        ...
        private static void PopulateQuests()
        {
            ...
            Quest clearAlchemistGarden = new Quest(QUEST_ID_CLEAR_ALCHEMIST_GARDEN, "Clear the alchemist's garden",
                                                    "Kill ratsin the alchemist's garden and bring back 3 rat tails." +
            ...
            Quest clearFarmersField = new Quest(QUEST_ID_CLEAR_FARMERS_FIELD, "Clear the farmer's field",
                                                "Kill snakes in the farmer's field and bring back 3 sanke fangs." +
