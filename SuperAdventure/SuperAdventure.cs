    ...
    public partial class SuperAdventure : Form
    {
        ...
        private void MoveTo(Location newLocation)
        {
            ...
            if (newLocation.QuestAvailableHere != null)
            {
                ...
                {
                    // The player has not completed the quest yet
        ...
        {
            //Get the currently selected weapon from the weapons combobox
            Weapon currentWeapon = (Weapon)cboWeapons.SelectedItem;

            //Determine the damage to do to the monster
            ...
            if (_currentMonster.CurrentHitPoints <= 0)
            {
                ...
                //Add items to the lootedItems, compering a random number to the drop percentage
                ...
                //Add looted items to the player's inventory
                ...
                //Move player to current location (to heal the player and create a new monster to fight)
                MoveTo(_player.CurrentLocation);
            }
            else
            {
                //Moster is still alive
